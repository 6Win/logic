...
etapa: [V2, V3, V4]
pilar: retencao
fonte: DADOS v2 (entrevista Nubank / Cristina Junqueira)
---
# Experiência substitui vendas: o caso Nubank (80% sem marketing)

**Mais de 80% dos clientes do Nubank chegam sem atribuição a marketing** — indicação, boca a boca,
mídia espontânea. Eles **não têm área de vendas**; têm área de **experiência / growth**.

A lógica: em vez de empurrar venda, **remover fricção** e fazer o cliente **amar** o produto. Cliente
que ama → indica → aquisição praticamente grátis. O objetivo não é só adquirir, é ser a **relação
principal** ("principalidade") — 60% dos clientes têm o Nubank como banco principal.
